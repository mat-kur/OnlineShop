        ...
        <div className="my-orders-container">
            ...
            <div className="my-orders-wrapper">
                ...
                <div className="order-status">
                    <button className="order-status-processing"><i className="fa-regular fa-clock"></i> Processing</button>
                    <button className="order-status-completed"><i className="fa-solid fa-check"></i> Completed</button>
                    <button className="order-status-cancelled"><i className="fa-solid fa-xmark"></i> Cancelled</button>
                </div>
